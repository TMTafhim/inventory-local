...
<section class="content">
      <div class="container-fluid">
        ...
        <!-- /.card -->
  <form method="post" action="?<?php echo substr($page_title,0,-7); ?>/<?php echo $MenuName; ?>/project_information" enctype="multipart/form-data">
        <!-- SELECT2 EXAMPLE -->
        ...
        <div class="col-md-12"><p style="text-align:center; color:#F00;">***All * marked fields are required***</p></div>
         ...
         <div class="col-md-6">
          ...
          <input type="text" class="form-control" name="location" placeholder="Location" id="name" required>
          </div>
                <!-- /.form-group -->
          </div>   
