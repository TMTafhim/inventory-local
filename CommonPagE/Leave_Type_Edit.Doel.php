            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
					...
					<input type="text" class="form-control" name="name" placeholder="Name" id="name" value="<?php echo $rowEditData["name"]; ?>"  required>
				  </div>
                <!-- /.form-group -->
              ...
              <div class="col-md-6">
                <div class="form-group">
					...
					<input type="text" class="form-control" name="number_of_days" placeholder="Number of Days" value="<?php echo $rowEditData["number_of_days"]; ?>"  id="number_of_days" required>
				  </div>
                <!-- /.form-group -->
