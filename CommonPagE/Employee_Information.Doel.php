          ...
          <table id="example1" class="table saas-table" >
              <thead>
                  <tr>
                      ...
                      <th style="width: 250px; text-align: center;">Options</th>
                      <?php } ?>
                  </tr>
              </thead>
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-center">
                          <div class="action-btn-group">
                              <a class="btn-saas-action btn-view-action" href="?<?php echo $page_title; ?>_View/<?php echo $MenuName; ?>/<?php echo $rowDataInformation["id"]; ?>/<?php echo $table; ?>">
                                  <i class="fas fa-eye"></i> View
                              </a>
                              <a class="btn-saas-action btn-edit-action" href="?<?php echo $page_title; ?>_Edit/<?php echo $MenuName; ?>/<?php echo $rowDataInformation["id"]; ?>/<?php echo $table; ?>">
                                  <i class="fas fa-pencil-alt"></i> Edit
                              </a>
                              <a class="btn-saas-action btn-delete-action" href="?<?php echo $page_title; ?>/<?php echo $MenuName; ?>/<?php echo $rowDataInformation["id"]; ?>/DELETE/employee_information">
