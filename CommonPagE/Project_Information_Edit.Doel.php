            ...
            <div class="row">
              ...
              <div class="col-md-6">
				  <div class="form-group">
					<label for="NAME">Menu Name:<span style="color:#F00;">*</span></label>
					<input type="text" class="form-control" name="name" placeholder="Unit Name" value="<?php echo $rowEditData["name"]; ?>" id="NAME" required>
				  </div>
                <!-- /.form-group -->
              </div>
              ...
              <div class="col-md-6">
          <div class="form-group">
          <label for="location"> Location:<span style="color:#F00;">*</span></label>
          <input type="text" class="form-control" name="location" placeholder="Location" value="<?php echo $rowEditData["location"]; ?>"  id="name" required>
          </div>
                <!-- /.form-group -->
          </div>   
