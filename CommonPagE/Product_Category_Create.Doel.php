...
<section class="content">
      <div class="container-fluid">
        ...
        <!-- /.card -->
  <form method="post" action="?<?php echo substr($page_title,0,-7); ?>/<?php echo $MenuName; ?>/product_category" enctype="multipart/form-data">
        <!-- SELECT2 EXAMPLE -->
        ...
        <div class="col-md-12"><p style="text-align:center; color:#F00;">***All * marked fields are required***</p></div>
          ...
          <input type="text" class="form-control" name="code" placeholder="Name" id="code" required>
          </div>
                <!-- /.form-group -->
          </div> 
