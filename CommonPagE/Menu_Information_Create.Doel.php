...
<section class="content">
      <div class="container-fluid">
        ...
        <!-- /.card -->
  <form method="post" action="?<?php echo substr($page_title,0,-7); ?>/<?php echo $MenuName; ?>/menu_information" enctype="multipart/form-data">
        <!-- SELECT2 EXAMPLE -->
        ...
        <div class="col-md-12"><p style="text-align:center; color:#F00;">***All * marked fields are required***</p></div>
          ...
          <input type="text" class="form-control" name="name" placeholder="Menu Name" id="name" required>
          </div>
                <!-- /.form-group -->
          </div>
