...
$Detail_information= $pdo->query("SELECT stock_transfer_information.*, product_information.name AS name FROM product_information INNER JOIN stock_transfer_information ON product_information.id=stock_transfer_information.product_id WHERE stock_transfer_information.transfer_id='$DocumentData' and received_status='Complete'");
$Today_Serial=1;	  
