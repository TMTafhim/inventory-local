            ...
            <div class="row">
              ...
              <div class="col-md-8">
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="NAME" placeholder="Menu Name" value="<?php echo $rowEditData["name"]; ?>" id="NAME" required>
				  </div>
                <!-- /.form-group -->
              </div>
             ...
             <div class="col-md-4">
          <div class="form-group">
          <label for="name"> Code:<span style="color:#F00;">*</span></label>
          <input type="text" class="form-control" value="<?php echo $rowEditData["code"]; ?>" name="code" placeholder="Name" id="code" required>
          </div>
                <!-- /.form-group -->
          </div>
              <!-- /.col -->
