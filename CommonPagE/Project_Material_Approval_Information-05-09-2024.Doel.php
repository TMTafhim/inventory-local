              ...
              <tbody>
				 ...
				 <?php
	              ...
	              while($rowDataProjectInfo= $ProjectInfo->fetch()){
					$db_table='project_approval_path_inforamtion'; 
				...
				if(!empty($rowDataProject_Material_Approval_Info)){	  
                  ...
                  <tr>
                      ...
                      <td>   <?php echo $rowDataProjectInfo["name"]; ?></td>
					  <td><?php
					$data_serial=1;
					$Project_Material_Approval_Info_employee = $pdo->query("SELECT employee_information.*,hr_designation.name AS employee_designation FROM project_approval_path_inforamtion INNER JOIN employee_information ON project_approval_path_inforamtion.employee_id=employee_information.id INNER JOIN hr_designation ON employee_information.designation=hr_designation.id WHERE project_approval_path_inforamtion.project_id='".$rowDataProjectInfo["id"]."' and project_approval_path_inforamtion.deleted_at is NULL order by project_approval_path_inforamtion.id DESC");	
                      ...
                      <td class="project-actions text-right">
                          ...
                          <a class="btn btn-danger btn-sm" href="?<?php echo $page_title; ?>/<?php echo $MenuName; ?>/<?php echo $rowDataProjectInfo["id"]; ?>/DELETE_Project_Material_Approval/<?php echo $db_table; ?>">
