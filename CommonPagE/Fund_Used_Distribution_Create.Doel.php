...
<section class="content">
  ...
  <form method="post" action="?Project_Material_Used_History/<?php echo $MenuName; ?>/material_used_summary" enctype="multipart/form-data">
    ...
    <div class="col-sm-4">
        ...
        <input class="form-control" value="Fund" name="material_used_type" id="material_used_type" type="hidden" required>
  ...
  <p>Requestion Detail :<span style="color:#FF0000">*</span></p>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <input type="text" id="used_amount1" name="used_amount1"  class="form-control" onkeyup="get_total_vaue();" oninput="calculate1()" placeholder="Amount Here .." required/>
            </td>
    ...
    <tfoot>
       ...
       <button type="button" class="btn btn-warning" onclick="history.back(-1)"><i class="fa fa-window-close"></i> Cancel</button>&nbsp;&nbsp;&nbsp;
        <button class="btn btn-primary" type="submit" name="Fund_Used_Distribution_Create"><i class="fa fa-save"></i> Submit </button>
                </div>
          </div>
        </div>
        <!-- /.card -->
...
$(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" class="form-control" onkeyup="get_total_vaue();" oninput="calculate' + counter + '()" id="used_amount' + counter + '" placeholder="Amount Here .." name="used_amount' + counter + '" required/></td>';
