...
<section class="content">
      <div class="container-fluid">
        ...
        <!-- /.card -->
  <form method="post" action="?<?php echo substr($page_title,0,-7); ?>/<?php echo $MenuName; ?>/user_login" enctype="multipart/form-data">
        <!-- SELECT2 EXAMPLE -->
          ...
          <div class="card-body">
			...
			<div class="col-md-3">
                <div class="form-group">
					...
					<input type="text" class="form-control" name="department" placeholder="Department" id="department" required>
				  </div>
                <!-- /.form-group -->
              </div>
			 ...
			 <div class="col-md-3">
			  ...
			  <div class="col-md-3">
                <div class="form-group">
					...
					<input type="text" class="form-control" name="no_value" placeholder="Password" id="Password" required>
				  </div>
                <!-- /.form-group -->
       ...
       <button type="button" class="btn btn-warning" onclick="history.back(-1)"><i class="fa fa-window-close"></i> Cancel</button>&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-primary" type="submit" name="User_Registration_Start"><i class="fa fa-save"></i> Save </button>
                </div>
          </div>
        </div>
        <!-- /.card -->
